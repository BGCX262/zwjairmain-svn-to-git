// DelCourse.cpp : implementation file
//
...
BEGIN_MESSAGE_MAP(CDelCourse, CFormView)
	//{{AFX_MSG_MAP(CDelCourse)
		// NOTE - the ClassWizard will add and remove mapping macros here.
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// CDelCourse diagnostics
...
void CDelCourse::OnInitialUpdate() 
{
	...
	GetParentFrame()->SetWindowText("学生选课");
	LOGFONT LogFont;
...
void CDelCourse::initial()
{
	...
	strSQL.Format("select * from COURSE \
					where COURSE_ID in( \
					select COURSE_ID \
					from COURSE_SCORE where STU_ID='%s')",m_ID);
